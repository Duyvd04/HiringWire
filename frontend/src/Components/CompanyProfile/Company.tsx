...
const Company = () => {
    ...
    return <div className="w-3/4">
        <div className="relative">
            ...
            <img className="w-36 h-36 border-deepSlate-950 p-2 bg-white border-8 absolute -bottom-1/4 left-5 rounded-3xl" src="/Icons/Google.png" alt="" />
        </div>
        <div className="px-7 mt-12">
            ...
            <div className="text-lg flex gap-1 items-center text-deepSlate-300">
        ...
        <div>
            <Tabs  variant="outline"  radius="md" defaultValue={section[0].toLowerCase()}>
                <Tabs.List className="font-semibold [&_button[data-active='true']]:!border-b-deepSlate-950 [&_button]:!text-xl mb-5 [&_button[data-active='true']]:text-oceanTeal-400">
                    {
