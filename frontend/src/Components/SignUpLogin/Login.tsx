...
const Login = () => {
  ...
  /><div data-aos="zoom-out" className="w-1/2 sm-mx:w-full px-20  bs-mx:px-10 md-mx:px-5  flex flex-col gap-3 justify-center">
        ...
        <div className="text-center sm-mx:text-sm xs-mx:text-xs">Don't have an account? <span className="text-oceanTeal-400 hover:underline cursor-pointer" onClick={()=>{navigate("/signup");setFormError(form) ;setData(form)}}>SignUp</span> </div>
        <div className="text-oceanTeal-400 sm-mx:text-sm xs-mx:text-xs hover:underline cursor-pointer text-center" onClick={open}>Forget Password?</div>
