...
const ApplicationForm = () => {
    ...
    return (
        <>
            ...
            />
            <div className="text-xl font-semibold mb-5 text-deepSlate-900">
            ...
            <div className="flex flex-col gap-5 bg-white p-4 rounded-lg">
                <div className="flex gap-10 md-mx:gap-5 [&>*]:w-1/2 sm-mx:[&>*]:!w-full sm-mx:flex-wrap">
                    <TextInput
                        ...
                        readOnly={true}
                        className={`${preview ? "text-deepSlate-600 font-semibold" : "bg-deepSlate-100"} rounded-lg`}
                ...
                />
                {!preview && (
                    <Button onClick={handlePreview} color="oceanTeal.4" variant="light">
                        Preview
                    </Button>
                )}
                {preview && (
