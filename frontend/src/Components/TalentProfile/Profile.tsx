        ...
        <div className="" >
            <div className="relative">
                ...
                <div className="absolute cursor-pointer flex items-center justify-center !rounded-full -bottom-1/3   md-mx:-bottom-10 sm-mx:-bottom-16  left-6">
                    ...
                    <Avatar className="!w-48  !h-48 md-mx:!w-40 md-mx:!h-40 border-deepSlate-950 border-8  rounded-full sm-mx:!w-36 sm-mx:!h-36 xs-mx:!h-32 xs-mx:!w-32" src={profile?.picture ? `data:image/jpeg;base64,${profile?.picture}` : '/avatar.png'} alt="" />
                </div>

            </div>
            <div className="px-3 mt-16">
                <div className="text-3xl xs-mx:text-2xl font-semibold flex justify-between">{profile?.name} <Button size={matches?"sm":"md"} color="oceanTeal.4" variant="light">Message</Button></div>
                ...
                <div className="text-lg flex xs-mx:text-base gap-1 items-center text-deepSlate-300">
                ...
                <div>
                    ...
                    <div className="text-sm text-deepSlate-300 text-justify">{profile?.about}</div>
                </div>
                <Divider my="xl" />
                <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {
                            profile?.skills?.map((skill: any, index: any) => <div key={index} className="bg-oceanTeal-300 rounded-3xl px-3 py-1 text-sm font-medium bg-opacity-15 text-oceanTeal-400">{skill}</div>)
                        }
